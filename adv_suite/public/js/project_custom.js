...
//         // Agregar el contenedor del carrusel al formulario
//         frm.fields_dict.attachments.$wrapper.append(carousel_container);

//         // Obtener los adjuntos del documento
//         let attachments = frm.get_docinfo().attachments;

//         // Filtrar los adjuntos de tipo imagen
//         let image_attachments = attachments.filter(attachment => {
//             return attachment.file_url.match(/\.(jpeg|jpg|gif|png)$/);
//         });

//         // Agregar las imágenes al carrusel
//         let carousel_inner = carousel_container.find('.carousel-inner');
//         image_attachments.forEach((attachment, index) => {
//             let active_class = index === 0 ? 'active' : '';
//             let carousel_item = $(`
//                 <div class="carousel-item ${active_class}">
//                     <img src="${attachment.file_url}" class="d-block w-100" alt="${attachment.file_name}">
//                 </div>
//             `);
